 ...
 * @ORM\Entity(repositoryClass="App\Repository\MouvementJeuRepository")
 */
class MouvementJeu
{
    /**
     ...
     * Add etatJeux
     *
     * @param \App\Entity\EtatJeu $etatJeux
     *
     * @return MouvementJeu
     */
    public function addEtatJeux(\App\Entity\EtatJeu $etatJeux)
    {
        $this->etatJeux[] = $etatJeux;
     ...
     * @param \App\Entity\EtatJeu $etatJeux
     */
    public function removeEtatJeux(\App\Entity\EtatJeu $etatJeux)
    {
    ...
    {
        return sprintf('Le %s vers %s par %s', $this->getDateMouvement()->format('d/m/Y'), $this->getDestination()->getNom(), $this->getGestionnaireJeu()->getNom());
    }
}
